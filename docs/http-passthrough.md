...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/Startup.cs#L11-L57' title='Snippet source file'>snippet source</a> | <a href='#startup' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<a id='appendclaimstomessageheaders'></a>
```cs
var configuration = new PassthroughConfiguration(
    connectionFunc: OpenConnection,
    callback: Callback,
...
services.AddSqlHttpPassthrough(configuration);
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/AppendClaimsToMessageHeaders.cs#L36-L48' title='Snippet source file'>snippet source</a> | <a href='#appendclaimstomessageheaders' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

A custom prefix can also be defined.

<!-- snippet: AppendClaimsToMessageHeaders_WithPrefix -->
<a id='appendclaimstomessageheaders_withprefix'></a>
```cs
var configuration = new PassthroughConfiguration(
    connectionFunc: OpenConnection,
    callback: Callback,
...
services.AddSqlHttpPassthrough(configuration);
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/AppendClaimsToMessageHeaders.cs#L19-L31' title='Snippet source file'>snippet source</a> | <a href='#appendclaimstomessageheaders_withprefix' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<a id='appendclaimstodictionary'></a>
```cs
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/AppendClaimsToMessageHeaders.cs#L53-L63' title='Snippet source file'>snippet source</a> | <a href='#appendclaimstodictionary' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

To extract claims:

<!-- snippet: ExtractClaimsFromDictionary -->
<a id='extractclaimsfromdictionary'></a>
```cs
var claimsList = ClaimsAppender.Extract(headerDictionary, "prefix.");
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/AppendClaimsToMessageHeaders.cs#L68-L72' title='Snippet source file'>snippet source</a> | <a href='#extractclaimsfromdictionary' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/AppendClaimsToMessageHeaders.cs#L76-L110' title='Snippet source file'>snippet source</a> | <a href='#claimsraw' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/PassThroughController.cs#L6-L25' title='Snippet source file'>snippet source</a> | <a href='#controller' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/Usage.html#L11-L40' title='Snippet source file'>snippet source</a> | <a href='#posttobus' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/Usage.html#L1-L9' title='Snippet source file'>snippet source</a> | <a href='#guid' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/Usage.cs#L13-L27' title='Snippet source file'>snippet source</a> | <a href='#clientformsender' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/SqlServer.Native.Tests/HttpPassthrough/Snippets/Usage.cs#L32-L50' title='Snippet source file'>snippet source</a> | <a href='#asptesthost' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
